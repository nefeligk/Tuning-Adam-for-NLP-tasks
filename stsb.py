...
## SPLIT DATA (RANDOM = 1) OK


dataset2 = dataset1.train_test_split(test_size=0.1666666666666, seed=1)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, seed=1)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, seed=1)["test"]
...
for i in range(len(train)):
    if train[i]['label'] >= 1 and train[i]['label'] < 2:
        traincount1 += 1
    if train[i]['label'] >= 2 and train[i]['label'] < 3:
        traincount2 += 1
    if train[i]['label'] >= 3 and train[i]['label'] < 4:
        traincount3 += 1
    if train[i]['label'] >= 4 and train[i]['label'] <= 5:
        traincount4 += 1

print('For train:')
print("1-2:", traincount1 / len(train))
print("2-3:", traincount2 / len(train))
print("3-4:", traincount3 / len(train))
print("4-5:", traincount4 / len(train))
...
for i in range(len(valid)):
    if valid[i]['label'] >= 1 and valid[i]['label'] < 2:
        validcount1 += 1
    if valid[i]['label'] >= 2 and valid[i]['label'] < 3:
        validcount2 += 1
    if valid[i]['label'] >= 3 and valid[i]['label'] < 4:
        validcount3 += 1
    if valid[i]['label'] >= 4 and valid[i]['label'] <= 5:
        validcount4 += 1

print('For valid:')
print("1-2:", validcount1 / len(valid))
print("2-3:", validcount2 / len(valid))
print("3-4:", validcount3 / len(valid))
print("4-5:", validcount4 / len(valid))
...
for i in range(len(test)):
    if test[i]['label'] >= 1 and test[i]['label'] < 2:
        testcount1 += 1
    if test[i]['label'] >= 2 and test[i]['label'] < 3:
        testcount2 += 1
    if test[i]['label'] >= 3 and test[i]['label'] < 4:
        testcount3 += 1
    if test[i]['label'] >= 4 and test[i]['label'] <= 5:
        testcount4 += 1

print('For train:')
print("1-2:", testcount1 / len(test))
print("2-3:", testcount2 / len(test))
print("3-4:", testcount3 / len(test))
print("4-5:", testcount4 / len(test))
...
def compute_metrics(eval_pred):
    ...
    print(results)
    if isinstance(round(results["pearson"], 2), float):
        pearson.append(round(results["pearson"], 2))
    id[0] = trainer.run_id()
    return {
        'pearson': max(pearson),
    }
...
def my_hp_space_optuna(trial) -> Dict[str, float]:
    return {
        ...
        "adam_beta1": trial.suggest_float("adam_beta1", 0.8, 95e-2, log=True),
        "adam_beta2": trial.suggest_float("adam_beta2", 0.9, 99999e-5, log=True),
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/test1", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
...
f = open('STSBadam_bestrun1.txt', 'w')

f.write(str(best_run))

f.close()

## SPLIT DATA (RANDOM = 10) OK


dataset2 = dataset1.train_test_split(test_size=0.1666666666666, seed=10)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, seed=10)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, seed=10)["test"]
...
# than the default to be able to prune bad trials early.
# Disabling tqdm is a matter of preference.
training_args = MyTrainingArguments("/home/LCARS/mirasta/test2", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
...
f = open('STSBadam_bestrun2.txt', 'w')

f.write(str(best_run))

f.close()

## SPLIT DATA (RANDOM = 100) OK


dataset2 = dataset1.train_test_split(test_size=0.1666666666666, seed=100)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, seed=100)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, seed=100)["test"]
...
# than the default to be able to prune bad trials early.
# Disabling tqdm is a matter of preference.
training_args = MyTrainingArguments("/home/LCARS/mirasta/test3", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
...
f = open('STSBadam_bestrun3.txt', 'w')

f.write(str(best_run))

f.close()

## SPLIT DATA (RANDOM = 1000) OK


dataset2 = dataset1.train_test_split(test_size=0.1666666666666, seed=1000)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, seed=1000)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, seed=1000)["test"]
...
# than the default to be able to prune bad trials early.
# Disabling tqdm is a matter of preference.
training_args = MyTrainingArguments("/home/LCARS/mirasta/test4", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
...
f = open('STSBadam_bestrun4.txt', 'w')

f.write(str(best_run))

f.close()

## SPLIT DATA (RANDOM = 10000) OK


dataset2 = dataset1.train_test_split(test_size=0.1666666666666, seed=10000)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, seed=10000)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, seed=10000)["test"]
...
# than the default to be able to prune bad trials early.
# Disabling tqdm is a matter of preference.
training_args = MyTrainingArguments("/home/LCARS/mirasta/test5", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
...
f = open('STSBadam_bestrun5.txt', 'w')
