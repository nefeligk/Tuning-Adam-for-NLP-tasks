...
def scores(y, pred, prob_pos, prob_neg):
    ...
    # f.write("Negative class precision: {:.2f}%".format(p_neg*100))
    # f.write("Positive class precision: {:.2f}%".format(p_pos*100))
    # f.write("Negative class recall: {:.2f}%".format(rec_neg*100))
    # f.write("Positive class recall: {:.2f}%".format(rec_pos*100))
    ...
    # MACRO
    # f.write("macro-precision: {:.2f}%".format(macro_precision*100))
    # f.write("macro-recall: {:.2f}%".format(macro_recall*100))
...
dataset2 = dataset1.train_test_split(test_size=0.1666666666666, stratify_by_column='label', seed=1)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=1)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=1)["test"]
...
def compute_metrics(eval_pred):
    ...
    if id[0] != trainer.run_id():
        global f1
        f1 = []
    f1.append(metric.compute(predictions=predictions, references=labels)['f1'])
    id[0] = trainer.run_id()
    return {
        'f1': max(f1),
    }
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/ttest1", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
...
f = open('MRPCadam_bestrun1.txt', 'w')
...
dataset2 = dataset1.train_test_split(test_size=0.1666666666666, stratify_by_column='label', seed=10)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=10)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=10)["test"]
...
# than the default to be able to prune bad trials early.
# Disabling tqdm is a matter of preference.
training_args = MyTrainingArguments("/home/LCARS/mirasta/ttest2", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
...
f = open('MRPCadam_bestrun2.txt', 'w')
...
dataset2 = dataset1.train_test_split(test_size=0.1666666666666, stratify_by_column='label', seed=100)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=100)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=100)["test"]
...
# than the default to be able to prune bad trials early.
# Disabling tqdm is a matter of preference.
training_args = MyTrainingArguments("/home/LCARS/mirasta/ttest3", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
...
f = open('MRPCadam_bestrun3.txt', 'w')
...
dataset2 = dataset1.train_test_split(test_size=0.1666666666666, stratify_by_column='label', seed=1000)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=1000)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=1000)["test"]
...
# than the default to be able to prune bad trials early.
# Disabling tqdm is a matter of preference.
training_args = MyTrainingArguments("/home/LCARS/mirasta/ttest4", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
...
f = open('MRPCadam_bestrun4.txt', 'w')
...
dataset2 = dataset1.train_test_split(test_size=0.1666666666666, stratify_by_column='label', seed=10000)

train = dataset2["train"]
valid = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=10000)["train"]
test = dataset2["test"].train_test_split(test_size=0.5, stratify_by_column='label', seed=10000)["test"]
...
# than the default to be able to prune bad trials early.
# Disabling tqdm is a matter of preference.
training_args = MyTrainingArguments("/home/LCARS/mirasta/ttest5", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
...
f = open('MRPCadam_bestrun5.txt', 'w')
